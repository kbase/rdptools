...
parser.add_option("-c", "--conf", dest="conf", 
                  help="assignment confidence cutoff used to determine the assignment count for each taxon. Range [0-1]", 
                  default="0.8")
...
parser.add_option("-g", "--gene", dest="gene", 
                  help= ', '.join(available_genes), default=available_genes[0])
parser.add_option("-s", "--seq", action="store_true", dest="seq", 
                  help="input a sequence instead of a file", default=False)
